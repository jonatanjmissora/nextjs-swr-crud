...
export default function TodosList() {
	...
	const { todos, isLoading, isValidating, error, isError } = useTodosProduction()
...
<div className="w-[700px] mx-auto p-6 bg-red-100 border-l-4 border-red-500 text-red-700 rounded">
					<div className="flex items-center">
						...
						<div>
							...
							<p>No se pudo conectar con el servidor. Por favor, verifica que la API esté en ejecución.</p>
							{error?.message && <p className="text-sm mt-1">Detalles: {error.message}</p>}
						</div>
					</div>
				</div>
	)
